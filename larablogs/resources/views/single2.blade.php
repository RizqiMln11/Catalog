			...
			<div class="container">
					...
					<div class="row">
							<div class="col-lg-4 single-right-left ">
										...
										<div class="flexslider1">
											...
											<ul class="slides">
												<li data-thumb="images/d2.jpg">
													<div class="thumb-image"> <img src="{{ $post->featured }}" data-imagezoom="true" class="img-fluid" alt=" "> </div>
												</li>
											</ul>
								...
								<div class="col-lg-8 single-right-left simpleCart_shelfItem">
									<h3>{{ $post->title }}</h3>
                                <p><span class="item_price">Rp.{{$prices->harga_diskon}}</span>
										<del>Rp.{{$prices->harga_normal}}</del>
									</p>
									<div class="rating1">
										<ul class="stars">
									...
									<div class="description">
										<h5>Tinggalkan pesan anda untuk Memesan!</h5>
										<form action="#" method="post">
                                                <input class="form-control" type="text" id="pesan" name="Email" placeholder="Isikan Pesan anda!" required="">
                                                <br>
                                                <br>
                                                <hr>
										</form>
									...
									<div class="color-quality">
										<div class="color-quality-right">
											<h5>Jumlah yg di Pesan :</h5>
                                                <select id="jml" onchange="change_country(this.value)" class="frm-field required sect">
                                                        <option value="">Silahkan di isi / Di isi dalam Kotak pesanan!</option>
                                    ...
                                    <div class="occasional">
										<h5>Category :</h5>
										<div class="colr ert">
                                        <label class="radio"><input type="radio" name="radio" checked=""><i></i>{{$post->category->name}}</label>
										</div>
										<div class="clearfix"> </div>
									</div>
				...
				<div class="container-fluid">
					...
					<div class="slider-img mid-sec mt-lg-5 mt-2 px-lg-5 px-3">
						<!--//banner-sec-->
						<h3 class="tittle-w3layouts text-left my-lg-4 my-3">Catalog Lainnya</h3>
						<div class="mid-slider">
							<div class="owl-carousel owl-theme row">
                                @foreach($postPluck as $postfive)
							<div class="item">
												...
												<div class="men-thumb-item">
													...
													<div class="men-cart-pro">
														<div class="inner-men-cart-pro">
															<a href="{{$postfive->slug}}" class="link-product-add-cart">Lihat Detail</a>
														</div>
													</div>
