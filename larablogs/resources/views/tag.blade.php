...
<section class="s-content s-content--top-padding">
        ...
        <div class="row narrow">
            <div class="col-full s-content__header" data-aos="fade-up">
                <h1 class="display-1 display-1--with-line-sep">Tag : {{ $tag->tag }} </h1>
                <p class="lead">Tampilan Post Sesuai Jenis Tags </p>
            </div>
        </div>
                      ...
                      <div class="item-entry" data-aos="zoom-in">
                        ...
                        <div class="item-entry__text">
                            <div class="item-entry__cat">
                                <a href="{{ route('post.single', ['slug' => $post->slug]) }}">{{ $post->category->name }}</a> 
                            </div>
...
<div class="header-bottom">
		<div class="container">
			<div class="logo">
                <p style="font-family: Georgia;"><label class="of"></label>Tags: {{ $title }}<label class="on"></label></p>
			</div>
		</div>
	</div>
